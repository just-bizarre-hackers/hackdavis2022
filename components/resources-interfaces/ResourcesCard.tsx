      ...
      <section className="p-8 flex flex-col space-y-2">
        <div className="flex items-center space-x-2">
          ...
          <a
            ...
            href="https://www.choosingwisely.org/patient-resources/allergy-tests/"
          >
            <BiWorld className="text-2xl transition-all hover hover:text-themeOrange" />
          </a>
        </div>
        <div className="flex items-center space-x-2">
          ...
          <a
            className="text-themeBlue font-medium"
            href="https://acaai.org/allergies/testing-diagnosis/"
          >
            <BiWorld className="text-2xl transition-all hover hover:text-themeOrange" />
          </a>
        </div>
        <div className="flex items-center space-x-2">
          ...
          <a
            className="text-themeBlue font-medium"
            href="https://www.labcorp.com/allergies"
          >
            <BiWorld className="text-2xl transition-all hover hover:text-themeOrange" />
          </a>
        </div>
